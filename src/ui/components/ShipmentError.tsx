...
const ShipmentError = ({offset, methods, filters}: {offset: number, methods: UseFormReturn, filters: any}) => {
  const {data: shipmentsData} = api.shipment.getTen.useQuery({offset, filters, statusFlag: "EXCEPTION"})
